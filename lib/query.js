function Query(connection) {
    ...
    this.asyncTransExecute = asyncTransExecute;
    this.asyncTransExecuteOne = asyncTransExecuteOne;
    ...
    async function asyncTransExecute(trans, procedureName) {
        let returns = await trans.query(this[this.params.length ? 'createQuery' : 'createQueryName'](procedureName));
    ...
    async function asyncTransExecuteOne(trans, procedureName) {
        let returns = await trans.oneOrNone(this[this.params.length ? 'createQuery' : 'createQueryName'](procedureName));
